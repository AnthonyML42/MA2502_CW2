...
## Second subsection {#sec::Subsec1.2}

Next we ask if these weights can truly be used in isolation to determine important factors relating to shot success? Refitting this model with a different set of predictors will yield different weights, possibly throwing our conclusions into question. We can add $\ell^1$ regularisation to the logistic models, which can shrink the coefficients of less powerful predictors to zero.
