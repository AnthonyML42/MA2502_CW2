...
auc_ci_result
pROC_obj <- roc(y_test, as.vector(pred_probs),
            smoothed = TRUE,
            # arguments for ci
...
```{r split-model-dot-whisker-plot, include=TRUE, fig.cap="THIS IS A BOOKDOWN CAPTION"}
#| echo=FALSE,
#| fig.width=12, 
#| fig.height=6
...
ggplot(coefs_plot, aes(x = estimate, y = term, colour = model, shape = sig)) +
  ...
  labs(
    ...
    colour = "Model",
    shape  = "Significance",
    caption = "THIS IS A CENTRED GGPLOT2 CAPTION"
